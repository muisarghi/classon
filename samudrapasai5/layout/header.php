...
<head>
  ...
  <link href="css/style.css" rel="stylesheet">
	...
	<style>
		.cover { width: 100%; }
		.testimonial-img {width: 100%; height: 500px;}
	</style>
...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="index.php"><span class="color-b"><?php echo "<img src='$logoskol' height='50px'> &nbsp;$namaskol"; ?></span></a>
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
		...
		?>
          ...
          <li class="nav-item dropdown <?php echo $lprofile; ?>">
          ...
          <li class="nav-item"><a class="nav-link" href="./admin/" target="_blank">Login</a></li>
        </ul>
      </div>
      <!--
