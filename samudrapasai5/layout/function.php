...
function index()
    ...
    <div class='container'>
		<div class='row'>
			<div class='col-md-8'>
				...
				";
				$profils=mysql_query("select * from profile order by id desc limit 1");
				while($profil=mysql_fetch_array($profils))
					{
				...
				<div class='accordion' id='accordionExample'>
					<div class='card'>
						...
						<div id='collapseOne' class='collapse show' aria-labelledby='headingOne' data-parent='#accordionExample'>
							<div class='card-body'>";
							$visis=mysql_query("select * from visimisi order by id desc limit 1");
							while($visi=mysql_fetch_array($visis))
								{
								echo"
								$visi[text]
								";
	...
	<div class='container-fluid p-0'>
		...
		";
		$galerys=mysql_query("select kategori_galeri.id, kategori_galeri.kategori as namakategori, galeri.* from galeri left join kategori_galeri on galeri.kat=kategori_galeri.id order by galeri.id desc limit 6");
	...
	$beritas=mysql_query("select kategori_berita.id, kategori_berita.kategori as namakategori, berita.* from berita left join kategori_berita on berita.kategori=kategori_berita.id order by berita.id desc limit 3");
	...
	<div class='container'>
		...
		$testisb=mysql_query("select * from testimoni order by id asc limit 1");
		while($testib=mysql_fetch_array($testisb))
			{
			echo"
				...
				<div class='testimonials-box'>
					<div class='row'>
						...
						<div class='col-sm-12 col-md-6 col-lg-6'>
							...
							".substr($testib['komentar'],0,100)."
							</p> $testib[nama]
							</div>
						
							<div class='testimonial-author-box'>
							  <h5><img src='$testib[img]' alt='' class='testimonial-avatar'> </h5>
							</div>
						</div>
			...
			*/
		$testis=mysql_query("select * from testimoni order by id desc");
		$no=1;
		while($testi=mysql_fetch_array($testis))
			{
			if($no==1)
				{$active="active";}
			else
				...
				<div class='testimonials-box'>
					<div class='row'>
						...
						<div class='col-sm-12 col-md-6 col-lg-6'>
							...
							<div class='testimonials-content'>
							<p class='testimonial-text'>
							".substr($testi['komentar'],0,100)."
							</p>$testi[nama]
							</div>
						
							<div class='testimonial-author-box'>
							  <h5><img src='$testi[img]' alt='' class='testimonial-avatar'> </h5>
							</div>
						</div>
	...
	$kepseks=mysql_query("select * from jajaran where jabatan like '%kepala sekolah%' order by id desc limit 1");
	while($kepsek=mysql_fetch_array($kepseks))
		{
...
function berita()
    ...
    <div class="container">
		...
		$a1=mysql_query("select kategori_berita.id, kategori_berita.kategori as namakategori, berita.* from berita left join kategori_berita on berita.kategori=kategori_berita.id order by berita.id desc limit $from, $max_results");
		while($a=mysql_fetch_array($a1))
			{
			echo"
			<div class='col-md-4'>
		...
		$jmlresult=mysql_query("SELECT COUNT(*) as jmlresult from berita ");
...
function detailberita()
	...
	$a1=mysql_query("select kategori_berita.id, kategori_berita.kategori as namakategori, berita.* from berita left join kategori_berita on berita.kategori=kategori_berita.id where berita.id='$id' and berita.status='1'");
	while($a=mysql_fetch_array($a1))
		{
		$judul=$a['judul'];
		$text=$a['text'];
...
function informasi()
    ...
    <div class="container">
		...
		$a1=mysql_query("select kategori_informasi.id, kategori_informasi.kategori as namakategori, informasi2.* from informasi2 left join kategori_informasi on informasi2.kat=kategori_informasi.id order by informasi2.id desc limit $from, $max_results");
		while($a=mysql_fetch_array($a1))
			{
			echo"
			<div class='col-md-4'>
		...
		$jmlresult=mysql_query("SELECT COUNT(*) as jmlresult from informasi2 ");
		while($jmresult=mysql_fetch_array($jmlresult))
			{
			$total_results=$jmresult['jmlresult'];
			}
...
function detailinformasi()
	...
	$a1=mysql_query("select kategori_informasi.id, kategori_informasi.kategori as namakategori, informasi2.* from informasi2 left join kategori_informasi on informasi2.kat=kategori_informasi.id where informasi2.id='$id'");
	while($a=mysql_fetch_array($a1))
		{
		$judul=$a['judul'];
		$text=$a['text'];
...
function galery()
	...
	<div class='container-fluid p-0'>
		<div class='row no-gutters'>
		";
		$a1=mysql_query("select kategori_galeri.id, kategori_galeri.kategori as namakategori, galeri.* from galeri left join kategori_galeri on galeri.kat=kategori_galeri.id where galeri.kat !=0 order by galeri.id DESC");
		while($a=mysql_fetch_array($a1))
			{
			echo"
			<div class='col-lg-4 col-sm-6'>
