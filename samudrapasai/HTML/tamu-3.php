        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="tujuan.html">Tujuan</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="informasi.html">Pengumuman</a>
              <a class="dropdown-item" href="galeri.html">Galeri</a>
              <a class="dropdown-item active" href="tamu.html">Buku Tamu</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
          ...
          <li class="nav-item"><a class="nav-link" href="https://onklas.com">E-Learning</a></li>
      ...
      <div class="row">
        <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
          <div class="post-content color-text-a mt-4">
            <p>
							Pesan disampaikan kepada <?php echo $_GET['toSend']; ?>
						</p>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">SMA Negeri Indonesia</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
