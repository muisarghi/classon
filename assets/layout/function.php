			...
			<div class="container">
				<div class="media-container-row">
					...
					Profile Sekolah</h1>
						...
						<?php
						$d1=mysqli_query($conn,"select * from profile order by id asc limit 1");
						while($d=mysqli_fetch_array($d1))
							{
		...
		<div>
			<div><!-- Filter -->
				...
				<div class="mbr-gallery-layout-default">
					<div>
						<div>
							<?php 
							$gal1=mysqli_query($conn,"select kategori_galeri.*, galeri.* from kategori_galeri left join galeri on kategori_galeri.id=galeri.kat limit 4");
							$no=0;
							while($gal=mysqli_fetch_array($gal1))
								{
								echo"
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="carousel-inner">	
								...
								<?php
								$gil1=mysqli_query($conn,"select * from galeri where kat !=0 order by kat,id ASC");
								while($gil=mysqli_fetch_array($gil1))
									{
									echo"
									<div class='carousel-item'>
									<img src='$gil[img]' alt='$gil[judul]' title=''>
									</div>
									";
									}
								?>
			...
			<section class="features3 cid-rs172xXCrl" id="features3-7">
				<div class="container">
					<div class="media-container-row">
						<?php
						$b1=mysqli_query($conn,"select * from berita order by id desc limit 3");
...
function sambutan()
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <?php
			$a1=mysqli_query($conn,"select * from sambutan order by id desc limit 1");
			while($a=mysqli_fetch_array($a1))
				{
				$text=$a['text'];
				$bg=$a['bg'];
...
function jajaran()
    ...
    <div class="container align-center">
        <div class="row media-row">
			...
			$c1=mysqli_query($conn,"select * from jajaran where jabatan not like '%WAKA%' and jabatan !='KEPALA SEKOLAH' ");
...
function berita()
	...
	$max=mysqli_query($conn,"select count(id) as num from berita");
	$a1=mysqli_query($conn,"select * from berita where status='1' order by id DESC");
	$no=1;
	while($a=mysqli_fetch_array($a1))
		{
		$nox=$no+2;
...
function detberita()
	...
	include 'inc/inc.php';
	$id=$_GET['id'];
	$a1=mysqli_query($conn,"select * from berita where id='$id'");
	while($a=mysqli_fetch_array($a1))
		{
		$judul=$a['judul'];
		$text=$a['text'];
...
function pengumuman()
	...
	$max=mysqli_query($conn,"select count(id) as num from informasi2");
	while($maxi=mysqli_fetch_array($max))
		{$count=$maxi['num'];}
			...
			<div class="mbr-gallery-row">
				<div class="mbr-gallery-layout-default">
					<div>
						<div>
							<?php 
							$a1=mysqli_query($conn,"select kategori_galeri.*, galeri.* from kategori_galeri left join galeri on kategori_galeri.id=galeri.kat order by galeri.id desc");
							$no=0;
							while($a=mysqli_fetch_array($a1))
								{?>
					...
					<div class="modal-content">
						<div class="modal-body">
							<div class="carousel-inner">	
								...
								$b1=mysqli_query($conn,"select kategori_galeri.*, galeri.* from kategori_galeri left join galeri on kategori_galeri.id=galeri.kat order by galeri.id desc");
								while($b=mysqli_fetch_array($b1))
									{
									echo"
									<div class='carousel-item'>
								...
								$bb1=mysqli_query($conn,"select kategori_galeri.*, galeri.* from kategori_galeri left join galeri on kategori_galeri.id=galeri.kat order by galeri.id asc limit 1");
								while($bb=mysqli_fetch_array($bb1))
									{
									echo"
...
function kontak()
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 class="pb-3 align-left mbr-fonts-style display-2">SMA N 1 Majapahit </h2>
                <div>
                    ...
                    <div class="icon-contacts pb-3">
                        <h5 class="align-left mbr-fonts-style display-7">Jl. Jendral Sudirman , 199 Surabaya</h5>
                        <p class="mbr-text align-left mbr-fonts-style display-7">Phone: +62 31 2345677
						<br>Email: info@sman1majapahit.sch.id</p>
                    </div>
                </div>
                <div>
                    <!---Formbuilder Form--->
...
function skontak()
	...
	$email=$_POST['email'];
	$a=mysqli_query($conn,"insert into kontak values ('', '$name', '$phone', '$email', '$message')");
	if($a)
		{
