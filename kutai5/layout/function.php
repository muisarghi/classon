	...
	*/
	...
	<section class='bg-light page-section' id='portfolio'>
		<div class='container'>
			...
			$galerys=mysql_query("select * from galeri order by id desc limit 6");
	...
	$c1=mysql_query("select kategori_galeri.id as idkat, kategori_galeri.kategori as namakategori, galeri.* from galeri right join kategori_galeri on kategori_galeri.id=galeri.kat order by galeri.id desc limit 6");
...
function galery()
	...
	<div class='container'>
		...
		<div class='row'>
		";
			$b1=mysql_query("select * from galeri where kat !=0 order by id desc");
			while($b=mysql_fetch_array($b1))
				{
				echo"
				<div class='col-md-4 col-sm-6 portfolio-item'>
	...
	$c1=mysql_query("select kategori_galeri.id as idkat, kategori_galeri.kategori as namakategori, galeri.* from galeri right join kategori_galeri on kategori_galeri.id=galeri.kat order by galeri.id desc");
	while($c=mysql_fetch_array($c1))
		{
		echo"
		<div class='portfolio-modal modal fade' id='portfolioModal$c[id]' tabindex='-1' role='dialog' aria-hidden='true'>
